...
define view entity ZDXC_SHB_M_BOOKING_SUPPL as select from /dmo/booksuppl_m
association to ZDXC_SHB_M_TRAVEL as _Travel
on $projection.TravelId = _Travel.TravelId
association to parent ZDXC_SHB_M_BOOKING as _Booking
